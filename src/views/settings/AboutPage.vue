...
const links = [
  { label: "GitHub", url: "https://github.com/Cifferni/cctoggle", desc: "项目仓库" },
  { label: "反馈问题", url: "https://github.com/Cifferni/cctoggle/issues", desc: "提交 Issue" },
];

function openUrl(url) {
  try {
    window.utools?.shellOpenExternal?.(url) || window.open(url, "_blank");
  } catch (e) {}
}
</script>
