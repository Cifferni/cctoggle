// uTools CCToggle 类型定义
// 为 window.utoolsCctoggle preload API 提供完整类型覆盖
...
export type AppType = 'codex' | 'claude' | 'claude-desktop' | 'openclaw' | 'gemini'
...
export interface UtoolsCctoggle {
  // 路径
  paths: {
    home: string
    codexAuth: string
